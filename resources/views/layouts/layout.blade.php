...
<head>
    ...
    <script src="{{ asset('global_assets/js/plugins/extensions/jquery_ui/touch.min.js') }}"></script>
    <script src="{{ asset('global_assets/js/plugins/sliders/slider_pips.min.js') }}"></script>
