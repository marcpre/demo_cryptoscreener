...
class OKEXTickData extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'Fetch tick data from okex';
    ...
    public function handle()
    {
        ...
        foreach ($tick as $obj) {
            ...
            */
            ...
            $ex = Exchange::where('name', 'OKEX')->first();;
